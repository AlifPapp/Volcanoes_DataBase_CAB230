...
const ThemeToggleButton = () => {
    ...
    return (
        <button onClick={() => setTheme(!enabledTheme)}
            className="fixed w-16 h-16 bottom-20 right-2 sm:bottom-10 sm:right-10 inline-flex items-center justify-center p-2 backdrop-blur-sm text-red-500 rounded-full shadow-2xl border-2 border-red-500 z-50">
            {enabledTheme ? (
