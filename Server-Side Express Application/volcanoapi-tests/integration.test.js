...
describe("volcano comments", () => {
  ...
  describe("retrieval of comments", () => {
    describe("with valid volcano ID", () => {
      beforeAll(async () => {
        const request = await to.object(instance.get(`volcano/1/comments`));
      ...
      test("should be an object result", () => expect(response.data).toBeInstanceOf(Object));
      test("should contain comments property", () => expect(response.data).toHaveProperty("comments"));
      test("should contain averageRating property", () => expect(response.data).toHaveProperty("averageRating"));
    });

    describe("with non-existent volcano ID", () => {
      beforeAll(async () => {
        const request = await to.object(instance.get(`volcano/99999/comments`));
        return (response = request.resolve ? request.resolve : request.reject.response);
      });
      ...
      test("should return error with boolean of true", () => expect(response.data.error).toBe(true));
      test("should contain message property", () => expect(response.data).toHaveProperty("message"));
      test("should return specific message 'Volcano with ID: 99999 not found.'", () => 
        expect(response.data.message).toBe("Volcano with ID: 99999 not found."));
    });
  });
  ...
  describe("posting a comment", () => {
    describe("without authorization header", () => {
      beforeAll(async () => {
        const request = await to.object(instance.post(`volcano/1/comment`, {
          comment: "Great volcano!",
          rating: 5,
        }));
        return (response = request.resolve ? request.resolve : request.reject.response);
      });
      ...
      test("should return status text - Unauthorized", () => expect(response.statusText).toBe("Unauthorized"));
      test("should return error with boolean of true", () => expect(response.data.error).toBe(true));
      test("should contain message property", () => expect(response.data).toHaveProperty("message"));
      test("should return specific message 'Authorization header ('Bearer token') not found'", () => 
        expect(response.data.message).toBe("Authorization header ('Bearer token') not found"));
    });

    describe("with valid data and authorization", () => {
      beforeAll(async () => {
        const request = await to.object(instance.post(`volcano/1/comment`, {
      ...
      test("should contain message property", () => expect(response.data).toHaveProperty("message"));
      test("should return specific message 'Comment successfully added'", () => 
        expect(response.data.message).toBe("Comment successfully added"));
    });
    ...
    describe("with invalid rating", () => {
      ...
      test("should return error with boolean of true", () => expect(response.data.error).toBe(true));
      test("should contain message property", () => expect(response.data).toHaveProperty("message"));
      test("should return specific message 'Request body invalid: rating must be an integer between 1 and 5.'", () => 
        expect(response.data.message).toBe("Request body invalid: rating must be an integer between 1 and 5."));
    });

    describe("with missing comment or rating", () => {
      beforeAll(async () => {
        const request = await to.object(instance.post(`volcano/1/comment`, {
          comment: "",
        }, {
      ...
      test("should return error with boolean of true", () => expect(response.data.error).toBe(true));
      test("should contain message property", () => expect(response.data).toHaveProperty("message"));
      test("should return specific message 'Request body incomplete: comment and rating are required.'", () => 
        expect(response.data.message).toBe("Request body incomplete: comment and rating are required."));
    });
  });
});
